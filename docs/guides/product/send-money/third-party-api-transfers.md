# Third-Party Transfer API: Capturing Originator Details for Compliance | Wise Platform

Source: https://docs.wise.com/guides/product/send-money/third-party-api-transfers
